 ...
 *
 * Usage:
 *   node scripts/merge-glossary.js
 *   node scripts/merge-glossary.js --dry-run
 */
...
function main() {
  ...
  // Load master index
  let masterIndex = { entities: [], version: '1.0', lastUpdated: '' };
  ...
  // Update metadata
  masterIndex.version = (parseFloat(masterIndex.version || '1.0') + 0.1).toFixed(1);
